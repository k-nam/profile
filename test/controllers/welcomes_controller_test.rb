...
class WelcomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create welcome" do
    assert_difference('Welcome.count') do
      post welcomes_url, params: { welcome: { introduction: @welcome.introduction, portrait_url: @welcome.portrait_url } }
    end
  ...
  test "should update welcome" do
    patch welcome_url(@welcome), params: { welcome: { introduction: @welcome.introduction, portrait_url: @welcome.portrait_url } }
